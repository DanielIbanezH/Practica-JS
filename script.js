...
const pokeImg = document.querySelector('[data-pokemon-picture]');
const pokeImgContainer = document.querySelector('[data-pokemon-picture-container]');
...
const renderNotFound = () => {
    ...
    pokeImg.setAttribute('src', './img/pokemon_unknown.png');
